...
// every work/author/detective/translator/publisher/theme/award page instead of one empty shell for
...
const detectives = readData("detectives");
...
const routes = [
  ...
  "/detectives",
  ...detectives.map((d) => `/detectives/${d.id}`),
  "/translators",
