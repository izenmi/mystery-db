...
console.log(
  `generate-manifest: wrote ${works.length} works, ${authors.length} authors, ${detectives.length} detectives, ${translators.length} translators, ${publishers.length} publishers, ${themes.length} themes, ${awards.length} awards, ${seriesGenerated.length} series`
);
